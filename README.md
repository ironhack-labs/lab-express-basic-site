...
1. DONE : Run `npm init -y` to create a package.json file. 
2. DONE : Run `npm install express` to install the Express package. 
3. DONE : Create a `views/` directory that will hold your `.html` files. 
4. DONE : Create a `public/` directory that will hold other static files, such as your CSS stylesheets, scripts and images.
